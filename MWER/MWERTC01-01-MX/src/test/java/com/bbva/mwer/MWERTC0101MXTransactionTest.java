...
/**
 * Test for transaction MWERTC0101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MWERTC0101MXTest.xml" })
public class MWERTC0101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MWERTC0101MXTransactionTest.class);

	@Autowired
	private MWERTC0101MXTransaction transaction;
