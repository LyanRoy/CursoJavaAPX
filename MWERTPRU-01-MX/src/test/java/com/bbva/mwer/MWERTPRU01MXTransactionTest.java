...
/**
 * Test for transaction MWERTPRU01MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MWERTPRU01MXTest.xml" })
public class MWERTPRU01MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MWERTPRU01MXTransactionTest.class);

	@Autowired
	private MWERTPRU01MXTransaction transaction;
