...
/**
 * Test for transaction MWERT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MWERT00101MXTest.xml" })
public class MWERT00101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MWERT00101MXTransactionTest.class);

	@Autowired
	private MWERT00101MXTransaction transaction;
